    ...
    <div className="edit-event-page">
      ...
      <form onSubmit={handleSubmit} className="edit-event-form">
        <div className="form-group">
          <label>
            <MdTitle className="form-icon" /> Event Title
          </label>
          <input
            type="text"
            name="title"
        ...
        <div className="form-group">
          <label>
            <MdDescription className="form-icon" /> Description
          </label>
          <textarea
            name="description"
        ...
        <div className="form-group">
          <label>
            <MdLocationOn className="form-icon" /> Location
          </label>
          <input
            type="text"
            name="location"
        ...
        <div className="form-group">
          <label>
            <MdEventAvailable className="form-icon" /> Date and Time
          </label>
          <input
            type="datetime-local"
            name="date"
        ...
        <div className="form-row">
          <div className="form-group">
            <label>
              <MdAttachMoney className="form-icon" /> Ticket Price ($)
            </label>
            <input
              type="number"
              name="ticketPricing"
          ...
          <div className="form-group">
            <label>
              <MdLocalActivity className="form-icon" /> Total Tickets
            </label>
            <input
              type="number"
              name="totalTickets"
        ...
        <div className="form-group">
          <label>
            <MdImage className="form-icon" /> Image URL
          </label>
          <input
            type="text"
            name="image"
